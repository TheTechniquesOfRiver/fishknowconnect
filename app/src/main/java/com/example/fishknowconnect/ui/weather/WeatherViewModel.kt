...
class WeatherViewModel(preferenceHelper: PreferenceHelper, private val retrofitService: FishKnowConnectApiService): ViewModel() {
    ...
    fun getAllWeatherContents() {
        viewModelScope.launch(Dispatchers.Main) {
            ...
            try {
                val response =
                    retrofitService.getPostsByType(username,"Weather")
